...
CREATE SEQUENCE SURGERY_ID_SEQ START WITH 1 INCREMENT BY 1 MINVALUE 1 MAXVALUE 1000000 NOCYCLE;

---------------------------trigger for inserting into surgery table --------------------

CREATE OR REPLACE TRIGGER SURGERY_ID_TRIGGER BEFORE
  INSERT ON SURGERY FOR EACH ROW
BEGIN
  SELECT
    'SUR'
    || TO_CHAR(SURGERY_ID_SEQ.NEXTVAL, 'FM0000000') INTO :NEW.SURGERY_ID
  FROM
    DUAL;
END;
...
ALTER TABLE SURGERY MODIFY SURGERY_ID VARCHAR2(
  20
);