...
CREATE TABLE PAYMENT(
 ...
 CREATE TABLE PICTURETABLE (
    PICTURE_ID NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY PRIMARY KEY, -- Unique identifier for each entry
    URL VARCHAR2(255) NOT NULL,   -- URL of the profile photo
    PUBLIC_ID VARCHAR2(255) NOT NULL,   -- Public ID of the profile photo
    VERSION VARCHAR2(50) NOT NULL  -- Version of the profile photo
);
